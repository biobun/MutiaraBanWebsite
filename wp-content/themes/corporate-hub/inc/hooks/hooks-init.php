...
require get_template_directory() . '/inc/hooks/expertise.php';
require get_template_directory() . '/inc/hooks/about.php';
require get_template_directory() . '/inc/hooks/service.php';
require get_template_directory() . '/inc/hooks/recent-work.php';
require get_template_directory() . '/inc/hooks/testimonial.php';
require get_template_directory() . '/inc/hooks/team.php';
